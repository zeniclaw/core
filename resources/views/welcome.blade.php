...
<section class="hero">
  <div class="hero-content">
    <div class="hero-badge fade-up">
      <span class="dot"></span>
      <span>Open Source &middot; Self-Hosted &middot; AI Platform</span>
    </div>
    <h1 class="fade-up d1">
      Your AI Army,<br>
    ...
    <p class="fade-up d2">
      ZeniClaw is a self-hosted AI platform with 19 specialized agents that turn your WhatsApp into an autonomous command center. Manage projects, track finances, take meeting notes, learn with flashcards &mdash; all from a single chat.
    </p>
    ...
    <div class="hero-terminal fade-up d4">
      ...
      <div class="terminal-line"><span class="comment"># Scan QR, start chatting with your AI agents</span></div>
...
<section style="padding-top: 0;">
  <div class="section-inner">
    <div class="stats-row">
      <div class="stat-box fade-up"><div class="stat-number">19</div><div class="stat-label">AI Agents</div></div>
      <div class="stat-box fade-up d1"><div class="stat-number">5</div><div class="stat-label">LLM Providers</div></div>
      <div class="stat-box fade-up d2"><div class="stat-number">24</div><div class="stat-label">Data Models</div></div>
...
<section id="features">
  <div class="section-inner">
    ...
    <div class="features-grid">
      <div class="feature-card"><div class="feature-icon blue">&#x1F916;</div><h3>Autonomous Agents</h3><p>19 specialized AI agents that handle tasks end-to-end: code reviews, project management, finance tracking, meeting notes, and more. Each agent has its own memory and tools.</p></div>
      <div class="feature-card"><div class="feature-icon purple">&#x1F500;</div><h3>Agentic Loop</h3><p>LLM-driven decision loop with tool usage. Agents autonomously decide which tools to call, chain operations, and iterate up to 10 times to complete complex tasks.</p></div>
      <div class="feature-card"><div class="feature-icon green">&#x1F4AC;</div><h3>WhatsApp Native</h3><p>Direct Baileys integration &mdash; no paid APIs, no middleman. Send text, images, voice messages. Full multimodal support: PDFs, photos, audio transcription.</p></div>
      <div class="feature-card"><div class="feature-icon pink">&#x1F9E0;</div><h3>Persistent Memory</h3><p>Dual-layer memory system: daily notes for recent context and long-term facts for preferences and decisions. Your agents remember everything, across sessions.</p></div>
      <div class="feature-card"><div class="feature-icon amber">&#x1F6E0;</div><h3>GitLab DevOps</h3><p>SubAgents clone repos, create branches, write code with Claude Code CLI, auto-commit, push, and open merge requests. Full CI/CD pipeline from a WhatsApp message.</p></div>
      <div class="feature-card"><div class="feature-icon red">&#x1F512;</div><h3>Self-Hosted & Secure</h3><p>100% on-premise. AES-256 encrypted secrets, role-based access control (superadmin/admin/operator/viewer), agent sandboxing, and full audit trail.</p></div>
      <div class="feature-card"><div class="feature-icon blue">&#x1F4CA;</div><h3>Finance Tracker</h3><p>Track expenses, manage budgets, get financial analytics and alerts. Categorize spending, set thresholds, and receive WhatsApp notifications when limits are reached.</p></div>
      <div class="feature-card"><div class="feature-icon purple">&#x1F3B5;</div><h3>Spotify Integration</h3><p>Search tracks, get personalized recommendations, create and manage playlists, view top charts and lyrics &mdash; all through natural language in WhatsApp.</p></div>
      <div class="feature-card"><div class="feature-icon green">&#x1F4DD;</div><h3>Smart Meetings</h3><p>Record meetings, generate transcriptions, produce structured summaries with action items. Never miss a decision or follow-up again.</p></div>
      <div class="feature-card"><div class="feature-icon pink">&#x1F0CF;</div><h3>Flashcards & Learning</h3><p>Spaced Repetition System (SRS) for effective learning. Create decks, review cards with intelligent scheduling, track your progress over time.</p></div>
      <div class="feature-card"><div class="feature-icon amber">&#x23F0;</div><h3>Reminders & Events</h3><p>Database-backed reminders that survive restarts. Recurrence rules (daily/weekly/monthly), snooze, multi-channel delivery via WhatsApp, email, and push.</p></div>
      <div class="feature-card"><div class="feature-icon red">&#x1F50D;</div><h3>Content Summarizer</h3><p>Drop any URL &mdash; web pages, YouTube videos, articles &mdash; and get AI-generated summaries with customizable length. OCR for images and screenshots.</p></div>
    </div>
  </div>
</section>
...
<section id="agents" style="background: var(--bg-secondary);">
  <div class="section-inner">
    ...
    <h2 class="section-title">19 Specialized <span class="gradient-text">AI Agents</span></h2>
    <p class="section-desc">Each agent is purpose-built with its own system prompt, tool access, and isolated memory. The Router Agent automatically dispatches your messages to the right specialist.</p>
    <div class="agents-grid">
      ...
      <div class="agent-chip"><div class="agent-emoji">&#x1F4BB;</div><div class="agent-info"><h4>DevAgent</h4><p>Code assistance & GitLab tasks</p></div></div>
      ...
      <div class="agent-chip"><div class="agent-emoji">&#x1F3AE;</div><div class="agent-info"><h4>HangmanGameAgent</h4><p>Interactive word game</p></div></div>
      <div class="agent-chip"><div class="agent-emoji">&#x1F500;</div><div class="agent-info"><h4>RouterAgent</h4><p>Auto-dispatch to right agent</p></div></div>
    </div>
  </div>
</section>
...
<section id="architecture">
  <div class="section-inner">
    ...
    <p class="section-desc">Four Docker containers, zero external dependencies. Everything runs on your machine.</p>
...
<pre>
  ...
  +-----------+       +-----------|----------------------+       +-------------+
                                  ...
                                  v                                     |
                      +----------------------------------+       +-------------+
                      |  <span class="hl-blue">App</span> (port 8080)                |       |  <span class="hl-purple">OpenAI</span>    |
                      |  Laravel 11 + PHP 8.4            |------&gt;|  GPT-4o     |
                      |                                  |       |  GPT-4o Mini|
                      |  <span class="hl-amber">RouterAgent</span> --&gt; 19 Agents      |       +-------------+
                      |  <span class="hl-amber">Agentic Loop</span> (tool chaining)   |
                      |  <span class="hl-amber">SubAgents</span> (Claude Code CLI)    |       +-------------+
                      |  Dashboard + Admin UI            |       |  <span class="hl-pink">GitLab</span>    |
                      +-----------|----------------------+       |  Repos, MRs |
                                  |                              +-------------+
                      +-----------|-----------+
                      |           v           |
    ...
    <div class="tech-grid" style="margin-top: 2rem;">
      ...
      <div class="tech-item"><div class="tech-icon">&#x1F3F0;</div><span>Laravel 11</span></div>
      ...
      <div class="tech-item"><div class="tech-icon">&#x1F4E6;</div><span>Node.js 20</span></div>
      <div class="tech-item"><div class="tech-icon">&#x1F433;</div><span>Docker</span></div>
      <div class="tech-item"><div class="tech-icon">&#x1F4F1;</div><span>Baileys</span></div>
      <div class="tech-item"><div class="tech-icon">&#x1F9E0;</div><span>Claude API</span></div>
    </div>
  </div>
</section>

<section id="install" style="background: var(--bg-secondary);">
  <div class="section-inner">
    ...
    <div class="install-steps">
      <div class="install-step">
        ...
        <div class="step-content">
          <h3>Prerequisites</h3>
          <p>You need a Linux server (Ubuntu 20.04+ recommended) with at least 2GB RAM and Docker installed.</p>
      ...
      <div class="install-step">
        ...
        <div class="step-content">
          <h3>Clone & Install</h3>
          <p>Clone the repository and run the interactive installer.</p>
      ...
      <div class="install-step">
        ...
        <div class="step-content">
          ...
          <p>Open <code style="background:var(--bg-primary);padding:2px 8px;border-radius:4px;font-family:var(--mono);font-size:0.85em;">http://your-server:3000</code> and scan the QR code with WhatsApp.</p>
        </div>
      </div>
      <div class="install-step">
        ...
        <div class="step-content">
          ...
          <p>Log into the dashboard to configure agents, manage projects, and monitor your system.</p>
      ...
      <div class="install-step">
        ...
        <div class="step-content">
          ...
          <p>Send a message to your linked WhatsApp number. The RouterAgent will dispatch it to the right agent.</p>
        </div>
      </div>
    </div>
  </div>
...
<section>
  <div class="section-inner" style="text-align: center;">
    ...
    <p class="section-desc" style="margin: 0 auto 2rem;">Deploy your own AI command center in minutes. Open source, self-hosted, completely free.</p>
...
<footer>
  <div class="footer-inner">
    ...
    <p class="footer-copy">&copy; {{ date('Y') }} ZeniClaw by ZeniBiz &mdash; Self-hosted AI WhatsApp Platform</p>
  </div>
</footer>
