...
{
    protected $fillable = ['agent_id', 'session_key', 'channel', 'peer_id', 'display_name', 'last_message_at', 'message_count', 'active_project_id', 'pending_switch_project_id', 'pending_agent_context', 'active_custom_agent_id', 'whitelisted', 'debug_mode'];
