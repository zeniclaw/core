...
class ChatAgent extends BaseAgent
{
    ...
    private function buildSystemPrompt(AgentContext $context): string
    {
        ...
        $systemPrompt =
            ...
            . "MEMOIRE: utilise recall_knowledge AVANT de redemander une info. "
            . "SAUVEGARDE PROACTIVE: Si l'utilisateur mentionne son prenom, profession, preference, habitude ou contexte personnel, appelle memory_store IMMEDIATEMENT sans attendre. "
            . "Exemples: prenom/nom → memory_store, langue preferee → memory_store, horaires/habitudes → memory_store, preferences de communication → memory_store.\n\n"
